...
# Hardcoded credentials (do not use .env or environment variables)
KITE_API_KEY = 'i3lwf5icae8f9ukq'
KITE_API_SECRET = 'wlhi7qhp4lxmhlzbz135sh3h9t4oiqfv'
KITE_ACCESS_TOKEN = 'aBBz6MAoPvLq21lB507eIAo0nj4SPze4'
TOTP_SECRET = '232KJV23NIVOAW3ZX2HMONDPFOJW6JT4'
SUPABASE_URL = 'https://dysxgiecblsagpkwfugu.supabase.co'
SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImR5c3hnaWVjYmxzYWdwa3dmdWd1Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MjY4NDU4OCwiZXhwIjoyMDY4MjYwNTg4fQ.q2jvJxiumtLUuKNapdDAdWVzQjSOjqDuvYUx5nRewDU'
KITE_USERNAME = 'ZFU212'
KITE_PASSWORD = 'Aabi2912!'
SUPABASE_SERVICE_ROLE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImR5c3hnaWVjYmxzYWdwa3dmdWd1Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MjY4NDU4OCwiZXhwIjoyMDY4MjYwNTg4fQ.q2jvJxiumtLUuKNapdDAdWVzQjSOjqDuvYUx5nRewDU'
...
if __name__ == "__main__":
    ...
    socketio.run(app, host="0.0.0.0", port=int(os.environ.get("PORT", 5500)))
